 ...
 */
/** How the CLI was staged for a leg: the driver installed it, or the agent must (`evals/lib/mode.ts`). */
export type EvalMode = 'installed' | 'not-installed';
/** A harness name (`evals/lib/contracts.ts`): the mailbox sub-address a deployment login uses. */
