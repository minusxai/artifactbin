...
function ctx(leg: Partial<Leg> & Pick<Leg, 'harness' | 'model'>): HarnessRunContext {
  return {
    leg: { envVar: 'SOME_API_KEY', apiKey: 'the-secret', label: leg.harness, price: null, vision: true, promptLevel: 'starter', mode: planMode(leg.harness, 'installed'), ...leg },
    prompt: 'Help me edit my artifact at http://127.0.0.1:3101/a/abc123. Use the afbin CLI to operate artifactbin.\n\nDo the thing.',
    cwd: '/tmp/run/cwd',
