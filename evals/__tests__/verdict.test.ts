...
/**
 * A check the driver COULD NOT OBSERVE must not decide a run: an agent that reaches the product through
 * its provider's own server-side tool leaves no local traffic, and failing it for "did not read the docs"
 * is a statement about our instrument, not about it.
 */
