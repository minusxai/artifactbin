...
let requests=0, trialRequests=0;
const trialRequestLimit=24, trialTurnLimit=20;
const relay=http.createServer(async(req,res)=>{
  try {
    if(++trialRequests>trialRequestLimit)throw new Error('Per-trial provider request budget exhausted');
    requests++;
