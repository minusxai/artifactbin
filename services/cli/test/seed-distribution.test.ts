...
const todo={todo:'workstream D: distribution and teaching'};
...
test('update --dry-run resolves the compatible release and reports binary, skill and plugin changes without installing',todo,async()=>{
...
test('help --format man and --output write bundled documentation offline',todo,async()=>{
...
test('the bundled teaching never instructs an npm install or a remote skill fetch',todo,()=>{
