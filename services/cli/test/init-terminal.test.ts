 ...
 * detected harness without prompting or reaching the network, then prints the brief.
 */
test('a local command installs the detected skill offline and prints the brief',{timeout:20000},async()=>{
 ...
 try{
  ...
  // The brief printed, and no interactive checklist ever appeared.
