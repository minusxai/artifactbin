...
export interface Operation {version:3;identity:unknown;context?:unknown;key:string;server:string;account:string|null;intent:string;method:string;path:string;body:unknown;checksum:string;response?:Record<string,unknown>}
