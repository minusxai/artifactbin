...
function address(value:string):string{
 if(/^[a-z][a-z\d+.-]*:/i.test(value)&&! /^(https?:|mailto:|ref:)/i.test(value))throw new CliError('unsupported_markdown','Unsupported Markdown link protocol.','Use an HTTPS URL, /a/ID or ref:ID.');
