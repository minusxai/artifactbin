...
export const flags: Record<string,Flag> = {
 ...
 dir:{value:'PATH',description:'Store server settings and uploaded objects here; defaults to ~/.artifactbin/server.'},
 'db-url':{value:'URL',description:'Override the server application database with pglite:// or postgres://; object storage stays under --dir.'},
 ...
 og:{description:'Export the selected social preview image: uploaded cover or saved document framing.'},
 refresh:{description:'Refresh the selected resources\' external data or imported assets; on export, wait for a fresh image. Requires explicit targets.'},
...
export const commands: Command[] = [
 ...
 {name:'mention',usage:'<ref> <@username> [<@username> ...]',description:'Resolve eligible @usernames to stable mentions. Save the returned markup or post the comment to notify them.',min:2,max:31,flags:[],examples:['afbin mention a1B2c3 @alex --json']},
 {name:'invite',usage:'<ref> <@username> [<@username> ...]',description:'Invite eligible people to an artifact. Auto-accept follows recipient preferences; never forces membership.',min:2,max:31,flags:[],examples:['afbin invite a1B2c3 @alex @sam --json']},
