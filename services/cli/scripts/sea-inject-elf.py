...
assert not any(note.name.startswith('NODE_SEA_BLOB') for note in binary.notes), 'SEA note already exists'
...
notes = [note for note in verified.notes if note.name.startswith('NODE_SEA_BLOB')]
