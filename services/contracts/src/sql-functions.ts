...
export const SQL_FUNCTIONS: readonly SqlFunctionSpec[] = [
  ...
  { name: 'regr_intercept', arity: [2], kind: 'aggregate', signature: 'regr_intercept(y, x) → real', summary: 'Where the least-squares line of y against x crosses x = 0.' },
  { name: 'corr', arity: [2], kind: 'aggregate', signature: 'corr(y, x) → real', summary: 'Pearson correlation of y and x, over rows with both.' },
  ...
  { name: 'to_number', arity: [1], kind: 'scalar', signature: 'to_number(text) → real', summary: "The number text names ('1.5', ' 2 ', '1e3'); null when it names none." },
