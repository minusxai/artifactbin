...
import { freePort, withHttpServer } from '@artifactbin/test-support/net';
...
const testFiles = (): string[] => {
  ...
  for (const s of ['services/app', 'services/auth', 'services/sql', 'services/utils', 'services/browser']) walk(path.join(ROOT, s));
