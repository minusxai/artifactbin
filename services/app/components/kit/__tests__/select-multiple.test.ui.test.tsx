...
/**
 * Popup portal theming: the menu escapes a clipping ancestor into the body,
 * so the artifact's tokens and typography have to travel with it.
 */
describe('popup portal theming', () => {
