...
const svgProps = ({ size = 16, className }: IconProps) =>
  ({
    viewBox: '0 0 24 24',
    width: size,
    height: size,
...
export function ClaudeCodeIcon(props: IconProps) {
  return (
    <svg {...svgProps(props)} fill="#D97757" fillRule="evenodd">
      <path
        clipRule="evenodd"
...
/** The Claude starburst — claude.ai, same terracotta. */
export function ClaudeAIIcon(props: IconProps) {
  return (
    <svg {...svgProps(props)} fill="#D97757" fillRule="nonzero">
...
/** The OpenAI blossom — ChatGPT. Mono by brand; inherits the theme's ink. */
...
/** Codex — the blue-violet gradient mark. The source SVG seats it on a white
 * tile; that rect is dropped so it sits transparent like the other marks. */
  ...
  return (
    <svg {...svgProps(props)}>
      <path
        ...
        fill="url(#mx-codex-grad)"
      />
      <defs>
        <linearGradient gradientUnits="userSpaceOnUse" id="mx-codex-grad" x1="12" x2="12" y1="3" y2="21">
...
/** GitHub's official Invertocat mark. Monochrome by brand, so it takes the surrounding
 * theme ink — which is what a link wearing it needs on both palettes. */
export function GitHubIcon(props: IconProps) {
  return (
    <svg {...svgProps(props)} viewBox={GITHUB_MARK_VIEWBOX} preserveAspectRatio="xMidYMid meet" fill="currentColor">
