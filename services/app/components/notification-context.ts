...
export const NotificationContext=createContext<{state:InboxState|null;error:string;load:(input?:object)=>Promise<void>;open:()=>void;loadMore?:()=>Promise<void>}|null>(null);
