 ...
 * the same shelf, less what needs the app behind it: no follow header (a session and
  ...
  return (
    <>
      <ListingHero
        ...
        // The follow header is the app's alone, and needs the owner's id to act on.
        {...(!domain && data.owner && data.social ? { social: { userId: data.owner.id, social: data.social, signedIn: !!data.authed } } : {})}
      />
