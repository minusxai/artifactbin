...
const FIXTURES: Fixtures = {
  artifact: {
    ...
    joined: {user_id:'usr_a',revision:1},
    left: {user_id:'usr_a',revision:2},
    invited: {user_id:'usr_a',revision:1},
    mentioned: {user_id:'usr_a',revision:1,mention_ref:'node:n1'},
    join_requested: {user_id:'usr_a',revision:1},
    invitation_dismissed: {user_id:'usr_a',revision:2},
    annotation_reopened: {annotation_id:'ann_1'},
    liked: {},
    unliked: {},
  },
  user: {
