...
describe('the human docs address', () => {
  it('every human link points at /docs-human', () => {
    for (const f of ['components/HeaderBar.tsx', 'components/LandingFooter.tsx', 'components/PageChrome.tsx', 'web/pages/TokensNew.tsx', 'web/App.tsx', 'lib/story/document.ts']) {
