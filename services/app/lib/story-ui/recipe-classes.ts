...
export const STORY_UI_RECIPE_CLASSES: readonly string[] = [
  ...
  "5v14M5",
  "800px",
  "@/components/PersonMention",
  "@/components/Tooltip",
  "@/components/kit/button",
  "@/components/kit/cn",
  "@/components/kit/controls",
  "@/components/kit/data-table",
  "@/components/kit/deck-gl",
  "@/components/kit/dialog",
  "@/components/kit/files",
  "@/components/kit/grid",
  "@/components/kit/icon",
  "@/components/kit/mermaid",
  "@/components/kit/sign-in",
  "@/components/kit/user",
  "@/components/kit/user-handle",
  "@/components/kit/user-image",
  ...
  "@/lib/artifact-backend/context",
  "@/lib/artifact-backend/http",
  "@/lib/basemap",
  "@/lib/chart/chart-theme",
  ...
  "Map.Title",
  "March",
  "Math.max(0,Math.min(10000,minHeight))",
  "May",
  "Menlo,",
  "Mermaid",
  "Next",
  ...
  "grid-cols-7",
  "grid-cols-[0_1fr]",
  "grid-cols-[repeat(var(--g-cols),minmax(0,1fr))]",
  "grid-rows-[auto_auto]",
  "group",
