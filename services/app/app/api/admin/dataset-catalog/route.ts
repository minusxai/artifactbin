...
const KEYS = new Set(['batchSize','dryRun','maxHistoricalVersionsPerArtifact','after','expected','allowPartial']);
export async function POST(request: Request): Promise<Response> {
  ...
  if (input.allowPartial!==undefined && typeof input.allowPartial!=='boolean') return json({error:'invalid_partial_mode'},400);
