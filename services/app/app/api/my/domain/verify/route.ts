 ...
 * caa_blocks } naming the first failing check; 404 not_found for a hostname
...
const VERIFY_STATUS = { disabled: 403, not_found: 404, txt_missing: 422, not_pointing: 422, caa_blocks: 422 } as const;
