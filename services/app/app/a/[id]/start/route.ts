...
const goneText = (base: string) => [
  ...
  '  ask them for a fresh start link,',
  `  or run afbin auth --server ${base} and ask your human to approve the browser flow.`,
  '  afbin help publishing-auth explains local setup and authentication.',
  '',
