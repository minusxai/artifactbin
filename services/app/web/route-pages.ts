...
export const routePages = {
  ...
  DatasetEditorPage: lazyPage<Record<string, never>>(() => import('./pages/DatasetEditor').then(m => ({ default: m.DatasetEditorPage }))),
  ...
  TokensNewPage: lazyPage<Record<string, never>>(() => import('./pages/TokensNew').then(m => ({ default: m.TokensNewPage }))),
