 ...
 */
export function ProfileListing({ data }: { data: { kind: string; handle: string; folder?: string; folders?: string[]; owner?: { id: string }; follow?: { following: boolean; count: number }; authed?: boolean; files: Array<Record<string, unknown> & { id: string; format: string }> } }) {
