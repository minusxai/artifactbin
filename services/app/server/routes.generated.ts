...
import * as r20 from '@/app/api/health/route';
...
import * as r42 from '@/app/api/preview/route';
import * as r43 from '@/app/api/query/route';
import * as r44 from '@/app/api/session/token/route';
import * as r45 from '@/app/api/start/route';
import * as r46 from '@/app/api/tokens/[id]/route';
import * as r47 from '@/app/api/tokens/anonymous/route';
import * as r48 from '@/app/api/tokens/claim/route';
import * as r49 from '@/app/api/tokens/claimable/route';
import * as r50 from '@/app/api/tokens/reject/route';
import * as r51 from '@/app/api/tokens/route';
import * as r52 from '@/app/api/users/[id]/follow/route';
...
export const ROUTES: RouteEntry[] = [
  ...
  { path: "/api/health", dir: "/api/health", methods: ["GET"], module: r20 },
  ...
  { path: "/api/preview", dir: "/api/preview", methods: ["POST"], module: r42 },
  { path: "/api/query", dir: "/api/query", methods: ["POST"], module: r43 },
  { path: "/api/session/token", dir: "/api/session/token", methods: ["POST","DELETE"], module: r44 },
  { path: "/api/start", dir: "/api/start", methods: ["POST"], module: r45 },
  { path: "/api/tokens/:id", dir: "/api/tokens/[id]", methods: ["DELETE"], module: r46 },
  { path: "/api/tokens/anonymous", dir: "/api/tokens/anonymous", methods: ["POST"], module: r47 },
  { path: "/api/tokens/claim", dir: "/api/tokens/claim", methods: ["POST"], module: r48 },
  { path: "/api/tokens/claimable", dir: "/api/tokens/claimable", methods: ["POST"], module: r49 },
  { path: "/api/tokens/reject", dir: "/api/tokens/reject", methods: ["POST"], module: r50 },
  { path: "/api/tokens", dir: "/api/tokens", methods: ["POST"], module: r51 },
  { path: "/api/users/:id/follow", dir: "/api/users/[id]/follow", methods: ["GET","POST","DELETE"], module: r52 },
