// Native, typed import of the story-guidance YAML: @rollup/plugin-yaml parses it for Vitest;
// the runtime reads and parses the file itself; this declaration supplies the TYPE
// TypeScript cannot infer from a YAML file.
declare module '*/story-guidance.yaml' {
  ...
  interface StoryGuidanceDoc {
    ...
    /** Reserved; a theme's authoring guidance lives in
     * `skills/artifactbin/references/themes-<name>.md`. */
