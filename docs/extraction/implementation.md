...
The client uses SQLite. The OSS server defaults to PGLite and accepts Postgres; DuckDB
handles queries. Local preview reads registered files by ID and saves browser edits without
